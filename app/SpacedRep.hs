...
data Name = Info | Button1 | Button2 | Button3 | Button4 | Prose | TextBox | Edit2
...
data Screen = Presentation | MultiChoice | TextInput | Feedback | Feedback2 deriving (Show, Eq)
